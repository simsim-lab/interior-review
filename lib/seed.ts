...
export const SEED_CHECKLIST: ChecklistItem[] = [
  { id: "ck-1", title: "26' 7월~ 공부, 26' 12월~ 업체 미팅 시작 (3개월 전), 27' 1월 계약! (2개월 전), 공사는 6~7주(공사 기간은 넉넉하게, 줄이면 품질 하락)", body: "", sort: 1 },
  { id: "ck-2", title: "우리는 디자인? 올수리?", body: "", sort: 2 },
  { id: "ck-3", title: "한장 짜리 견적서는 피하고 모든 견적을 세세하게 표기한 견적서를 확인할 필요가 있다.", body: "", sort: 3 },
  { id: "ck-4", title: "단열, 방수, 배관 > 매우 중요!", body: "", sort: 4 },
  { id: "ck-5", title: "확장에 시스템 에어콘 + 샷시까지 쓰려면 평당 300.", body: "", sort: 5 },
  { id: "ck-6", title: "홈페이지 유무", body: "", sort: 6 },
  { id: "ck-7", title: "포트폴리오 업데이트 주기, 꾸준히 업데이트 되는지?", body: "", sort: 7 },
  { id: "ck-8", title: "지인 혹은 삼성 게시판 추천 업체", body: "", sort: 8 },
  { id: "ck-9", title: "AS시스템이 운영 중 인지 확인 (홈피에 존재하는지!)", body: "", sort: 9 },
  { id: "ck-10", title: "디자인에만 치중하지 않고 집의 정상적 기능 수행 및 실거주 입장에서 고려를 많이 하는지?", body: "", sort: 10 },
  { id: "ck-11", title: "오늘의집 최근 후기 보기", body: "", sort: 11 },
  { id: "ck-12", title: "현장 소장의 최대 관리 공사는 최대 2건으로 특약에 넣기", body: "", sort: 12 },
  { id: "ck-13", title: "법인에서 진행, 중소기업 현황정보시스템에서 재무 확인하기", body: "", sort: 13 },
  { id: "ck-14", title: "공사 매뉴얼 및 체크리스트 확인 그리고 일지도 확인가능한지문의", body: "", sort: 14 },
  { id: "ck-15", title: "3D 렌더링까지 되는지?", body: "", sort: 15 },
  { id: "ck-16", title: "디자인 요청서 양식이 있는지?", body: "", sort: 16 },
  { id: "ck-17", title: "지나친 레이아웃 변경은 지양", body: "", sort: 17 },
  { id: "ck-18", title: "히든도어 4년 썼는데 잘 된다더라~", body: "", sort: 18 },
  { id: "ck-19", title: "공개 주방생각보다 안튄다.", body: "", sort: 19 },
  { id: "ck-20", title: "후드 일체형 인덕션", body: "", sort: 20 },
  { id: "ck-21", title: "간접조명은 어찌 유지보수 하는지?", body: "", sort: 21 },
];
